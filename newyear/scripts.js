...
var mlas = [
  ...
  ['Doug Clovechok', 'doug.clovechok.MLA@leg.bc.ca', 'Columbia River-Revelstoke'],
  ['Joan Isaacs', 'joan.isaacs.MLA@leg.bc.ca', 'Coquitlam-Burke Mountain'],
  ['Selina Robinson', 'selina.robinson.MLA@leg.bc.ca', 'Coquitlam-Maillardville'],
  ...
  ['Jane Thornthwaite', 'jane.thornthwaite.MLA@leg.bc.ca', 'North Vancouver-Seymour'],
  ['Andrew Weaver', 'andrew.weaver.mla@leg.bc.ca', 'Oak Bay-Gordon Head'],
  ['Michelle Stilwell', 'michelle.stilwell.MLA@leg.bc.ca', 'Parksville-Qualicum'],
  ...
  ['Nicholas Simons', 'nicholas.simons.MLA@leg.bc.ca', 'Powell River-Sunshine Coast'],
  ...
  ['Spencer Chandra Herbert', 'spencer.herbert.MLA@leg.bc.ca', 'Vancouver-West End'],
